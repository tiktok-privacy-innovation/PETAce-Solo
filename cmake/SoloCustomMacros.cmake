...
macro(solo_combine_archives target dependency)
    if(MSVC)
...
macro(solo_fetch_thirdparty_content content_file)
    set(SOLO_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${SOLO_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${SOLO_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(SOLO_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
